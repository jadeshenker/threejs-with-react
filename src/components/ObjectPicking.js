...
export default class ObjectPicking extends Component {
    ...
    componentDidMount() {
        ...
        interaction = new Interaction(this.renderer, this.scene, this.camera);
    ...
    onMouseMove = (e) => {
        ...
        this.cubes.children.forEach(function(cube) {
            ...
            //change color of cube on click using the Interaction library 
            cube.on('click', ev => {
                cube.material.color.setRGB(77, 77, 255);
            });
        });
